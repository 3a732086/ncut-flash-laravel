...
@section('content')
            ...
            <table class="table datatable-button-print-rows" style="font-size:16px">
                ...
                @foreach($green_data as $data)
                    <tr>
                        ...
                        <td>{{$data->Adverb}}</td>
                        <td>
                            <form action="{{route('green.edit' , $data->id)}}" method="get" style="margin-top: 0px;margin-bottom: 0px;">
    ...
    <div class="row">
        <div class="card col-lg">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">新增詞彙(綠色區塊)</h5>
                <div class="header-elements">
                    <div class="list-icons">
                        <a class="list-icons-item" data-action="collapse"></a>
                        <a class="list-icons-item" data-action="reload"></a>
            ...
            <div class="card-body">
                <p class="mb-4"></p>
                <form action="{{route('green_word_insert')}}" method="post">
                    @csrf
                    <fieldset class="mb-3">
                        <div class="row">
                            <div class="col-lg-6">
